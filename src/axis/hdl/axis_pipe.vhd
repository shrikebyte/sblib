...
begin
  ...
  gen_ready_pipe : if G_READY_PIPE generate
    ...
    signal skid_axis_tdata : std_ulogic_vector(G_DW - 1 downto 0);
    signal skid_axis_tkeep : std_ulogic_vector(G_DW / 8 - 1 downto 0);
    signal skid_axis_tlast : std_ulogic;
    signal skid_axis_tuser : std_ulogic_vector(G_UW - 1 downto 0);
